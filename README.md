# DISCLAIMER
This ReadMe is just modified to match my script.
nothing else lol
...
## Creating a win
```lua
local win = lib:Makewin({Name = "Title of the library", HidePremium = false, SaveConfig = true, ConfigFolder = "OrionTest"})
...
print(lib.Flags["toggle"].Value) -- prints the value of the toggle.
```
